...
for($i=0;$i<sizeof($token);$i=$i+10)
{
	...
	?>
  <tr align="left" valign="top">
    <td width="287" height="22"><p class="style2"> <?php echo $titulo ?>   </p></td>
    <td width="98"><p class="style2"><?php echo $items ?> </td>
    <td width="186" class="style2"><?php echo $idioma ?></td>
    <td width="100" class="style2"><?php echo $espacio ?></td>
  </tr>
  <?php
	//cerramos bloque FOR
}
...
<p align="right" class="style2"><span class="MsoNormal">Registros mostrados = <?php echo $counter; ?> <br>
  ...
  <?php print (date("d/n/Y-H:i")); ?></span></p>
</body>
